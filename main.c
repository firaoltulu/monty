...
{
    instruction_t seven[] = {
        {"nop", Custom_nop}, {"sub", Custom_sub}, {"div", Custom_div}, {"push", Cutsom_push}, {"pall", Custom_pall}, {"pint", Custom_print}, {"mul", Cutsom_mul}, {"mod", Cutsom_mod}, {"pchar", Cutsom_pchar}, {"pop", Custom_pop}, {"swap", Custom_swap}, {"add", Custom_add}, {"pstr", Cutsom_pstr}, {"rotl", Cutsom_rotl}, {"rotr", Cutsom_rotr}, {"queue", Cutsom_queue}, {"stack", Cutsom_stack}, {NULL, NULL}};
